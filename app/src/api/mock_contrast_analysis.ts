...
export const mockContrastAnalysisResponse: { claimComments: ClaimComment[] } = {
  claimComments: [
    // Comment on the 3‑page document (page 3) with evidence in the 13‑page doc
    {
      id: "c1",
      filePath:
        "C:\\Users\\info\\AppData\\Local\\electron\\Electron\\Harlus\\AAPL\\AAPL_2017_Q3_internal_analysis_pdf\\content.pdf",
      commentGroupId: "g1",
      ...
      links: [
        {
          id: "l1",
          filePath:
            "C:\\Users\\info\\AppData\\Local\\electron\\Electron\\Harlus\\AAPL\\AAPL_2017_Q4_results_pdf\\content.pdf",
