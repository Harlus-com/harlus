...
export const mockContrastAnalysisResponse: { claimComments: ClaimComment[] } = {
  claimComments: [
    // Comment on the 3‑page document (page 3) with evidence in the 13‑page doc
    {
      id: "c1",
      filePath:
        "/Users/danielglasgow/Library/Application Support/Electron/Harlus/AMAT/AMAT_Q1_24_Results_pdf/content.pdf",
      commentGroupId: "g1",
      ...
      links: [
        {
          id: "l1",
          filePath:
            "/Users/danielglasgow/Library/Application Support/Electron/Harlus/AMAT/AMAT_Q2_2024_Earnings_Release_pdf/content.pdf",
